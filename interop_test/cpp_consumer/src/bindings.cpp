...
NB_MODULE(cpp_consumer, m) {
    ...
    m.def("bump_point_x", [](nb::handle obj, double dx) {
        cr_core::Point *p = cr_borrow<cr_core::Point>(obj, "cr_core.Point");
